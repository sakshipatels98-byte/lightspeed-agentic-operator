...
- [ ] Resource watching pattern: Owned resources tracked via ResourceVersion; external dependencies use explicit watches or indexing as appropriate for the controller
