...
- Focus on production code (`controller/`, `api/`, `cmd/`, `cli/`). Skip test duplication unless explicitly asked.
...
# Find similar generation helpers
...
5. Suggested location for shared code (e.g. next to callers or a small internal helper package)
